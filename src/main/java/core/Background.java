...
public class Background {
    ...
    public Background() {
        try {
            sky = ImageIO.read(getClass().getResourceAsStream("/assets/stage/forest_sky.png"));
            trees = ImageIO.read(getClass().getResourceAsStream("/assets/stage/forest_trees.png"));
            ground = ImageIO.read(getClass().getResourceAsStream("/assets/stage/forest_ground.png"));
            bushes = ImageIO.read(getClass().getResourceAsStream("/assets/stage/forest_bush.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
