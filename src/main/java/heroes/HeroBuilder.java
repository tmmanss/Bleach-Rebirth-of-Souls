...
public class HeroBuilder {
    ...
    public BaseHero build() {
        ...
        System.out.println("getResource (class): " + getClass().getResource(basePath + "/idle.png"));
        System.out.println("getResource (class, leading slash): " + getClass().getResource("/" + basePath + "/idle.png"));
        System.out.println("getResourceLoader: " + getClass().getClassLoader().getResource(basePath + "/idle.png"));
        ...
        try {
            ...
            BufferedImage attack = ImageIO.read(getClass().getResourceAsStream("/" + basePath + "/attack1.png"));
            BufferedImage rangedAttack = ImageIO.read(getClass().getResourceAsStream("/" + basePath + "/range_attack.png"));
            BufferedImage projectileSprite = ImageIO.read(getClass().getResourceAsStream("/" + basePath + "/projectile.png"));
